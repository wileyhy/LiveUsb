...
function _fn_error_and_exit_(){                       _als_fnction_boundary_in_
...
function _fn_write_bashrc_strings(){                _als_fnction_boundary_in_
  #_als_enble_locl_xtrce_
...
function _fn_write_ssh_conf(){                      _als_fnction_boundary_in_
  #_als_enble_locl_xtrce_
